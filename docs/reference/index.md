...
- [Each file under `.mdsmith/schemas/` declares one named schema. The basename is the schema name; the body carries the inline `schemas.<name>:` keys. A kind references one by name (`schema: rfc-v1`).](schema-files.md)
