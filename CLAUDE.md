...
- [GitHub fine-grained PAT for dispatching a manifest bump to the jeduden/scoop-mdsmith bucket. Plain repo secret — not gated by an environment.](docs/development/secret-rotations/scoop-bucket-dispatch-token.md)
